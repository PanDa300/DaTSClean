...
def SHoTClean_run(dirty_series):
    ...
    print(time)
    return time, result_series_SHoTClean_Soft
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            mytime, result_series_SHoTClean_Soft = SHoTClean_run(dirty_series)
